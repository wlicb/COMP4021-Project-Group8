...
const Box_desert = function(ctx, x, y) {

    const sequences = { direction: 0, x: 0, y: 12, width: 40, height: 40, count: 1, timing: 200, loop: false};
    ...
    sprite.setSequence(sequences)
        ...
        //   .setShadowScale({ x: 0.75, y: 0.2 })
          .useSheet("./resources/boxes_desert.png");
